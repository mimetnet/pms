...
AppMutex=pms-setup
OutputBaseFilename=pms-setup-0.7.0.0
...
Filename: {reg:HKLM\SOFTWARE\GTK\2.0,Path|C:\GTK\2.8}\bin\gacco.exe; Parameters: "/u ""PMS, Version=0.7.0.0, Culture=neutral, PublicKeyToken=1b9e664700a659b9, processorArchitecture=MSIL"""; Components: PMS; Flags: runhidden
...
Root: HKLM; Subkey: SOFTWARE\PMS\0.7.0.0; Flags: uninsdeletekeyifempty
Root: HKLM; Subkey: SOFTWARE\PMS\0.7.0.0; ValueType: string; ValueName: Path; ValueData: {app}\bin; Flags: uninsdeletevalue
...
var
	...
	PMS: Boolean;
begin
	//PMS := RegKeyExists(HKLM, 'SOFTWARE\PMS\0.7.0.0');
	PMS := false
	if PMS =true then
	begin
